     ...
     D msg             s             76
      /free
       ...
       // requetes sql clause order
         EXEC SQL
         select texte into :ord01 from subfile
       ...
       // Ligne 3
        ...
        INSERT INTO SUBFILE VALUES(:PGM01, 'WHERE', :WHE01) ;
         EXEC SQL
        INSERT INTO SUBFILE VALUES(:PGM01, 'ORDER', :ord01) ;
        ...
        *in52 = *on ;
        ...
        and LIBEL= 'WHERE';
         EXEC SQL
        UPDATE SUBFILE SET TEXTE = :ord01 WHERE PGM=:PGM01
        and LIBEL= 'ORDER';
          wpgm01 = opt01 + trt01 + posparm + lenparm + possel ;
         EXEC SQL
